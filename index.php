      ...
      <div id="header" class="skel-panels-fixed">
        ...
        <div class="top">
          ...
          <!-- Logo -->
            <div id="logo">
              ...
              <h1 id="title">&lt;Arpit, Shahvez & Alok presenting you&gt;</h1>
          ...
          <!-- Nav -->
            <nav id="nav">
              <ul>
                <li><a href="#portfolio" id="top-link" class="skel-panels-ignoreHref"><span class="icon icon-home">Home</span></a></li>
					...
					<section id="team" class="one">
						<div class="container">
							...
							<div class="row">
								<div class="4u">
									<article class="item">
										<a href="http://www.facebook.com/arpit.kumar.7798574" target="_blank" class="image full"><img src="img/arpit.jpg" alt="" /></a>
										<header>
											<h3>ARPIT KUMAR</h3>
										</header>
									</article>
								...
								<div class="4u">
									<article class="item">
										<a href="http://www.facebook.com/shahvez.alam.5688" target="_blank" class="image full"><img src="img/shahvez.jpg" alt="" /></a>
										<header>
											<h3>SHAHVEZ ALAM</h3>
										</header>
									</article>
									<article class="item">
										<a href="http://www.facebook.com/CMRInstituteOfTechnologyBangalore" target="_blank" class="image full"><img src="img/cmrit.png" alt="" /></a>
										<header>
											<h3>CMRIT</h3>
										</header>
									</article>
								...
								<div class="4u">
									<article class="item">
										<a href="http://www.facebook.com/alok.solanki.756" target="_blank" class="image full"><img src="img/alok.jpg" alt="" /></a>
										<header>
											<h3>ALOK SOLANKI</h3>
										</header>
									</article>
		...
		<!-- Footer -->
			<div id="footer">
				...
				<!-- Copyright -->
					<div class="copyright">
						<p>&copy; 2020 TeamCMRIT.in. All rights reserved.</p>
