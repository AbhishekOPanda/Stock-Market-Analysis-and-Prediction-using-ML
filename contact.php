...
<?php header('Refresh: 5; URL=http://localhost/iterators-master/index.php'); ?>
        ...
        <div class="bottom">
          ...
          <!-- Social Icons -->
            <ul class="icons">
              ...
              <li><a href="https://github.com/rohitkrai03" target="_blank" class="icon icon-github"><span>Github</span></a></li>
